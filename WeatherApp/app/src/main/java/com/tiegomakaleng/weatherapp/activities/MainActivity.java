package com.tiegomakaleng.weatherapp.activities;
...
import com.tiegomakaleng.weatherapp.AlarmReceiver;
import com.tiegomakaleng.weatherapp.Constants;
import com.tiegomakaleng.weatherapp.R;
import com.tiegomakaleng.weatherapp.adapters.ViewPagerAdapter;
import com.tiegomakaleng.weatherapp.adapters.WeatherRecyclerAdapter;
import com.tiegomakaleng.weatherapp.fragments.AboutDialogFragment;
import com.tiegomakaleng.weatherapp.fragments.AmbiguousLocationDialogFragment;
import com.tiegomakaleng.weatherapp.fragments.RecyclerViewFragment;
import com.tiegomakaleng.weatherapp.models.Weather;
import com.tiegomakaleng.weatherapp.tasks.GenericRequestTask;
import com.tiegomakaleng.weatherapp.tasks.ParseResult;
import com.tiegomakaleng.weatherapp.tasks.TaskOutput;
import com.tiegomakaleng.weatherapp.utils.Formatting;
import com.tiegomakaleng.weatherapp.utils.UI;
import com.tiegomakaleng.weatherapp.utils.UnitConvertor;
import com.tiegomakaleng.weatherapp.widgets.AbstractWidgetProvider;

import static com.tiegomakaleng.weatherapp.utils.TimeUtils.isDayTime;
...
public class MainActivity extends BaseActivity implements LocationListener {
    ...
    private CollapsingToolbarLayout currentWeatherImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentWeatherImage = findViewById(R.id.collapsingToolbarLayout);
...
//        }
    ...
    private void updateTodayWeatherUI() {
        ...
        if (todayDescription.getText().toString().contains("sun")) {
            currentWeatherImage.setBackgroundResource(R.drawable.forest_sunny);
            tabLayout.setBackgroundColor(getResources().getColor(R.color.sunny));
            viewPager.setBackgroundColor(getResources().getColor(R.color.sunny));
        } else if (todayDescription.getText().toString().contains("cloud")) {
            currentWeatherImage.setBackgroundResource(R.drawable.forest_cloudy);
            tabLayout.setBackgroundColor(getResources().getColor(R.color.cloudy));
            viewPager.setBackgroundColor(getResources().getColor(R.color.cloudy));
        } else if (todayDescription.getText().toString().contains("rain")) {
            currentWeatherImage.setBackgroundResource(R.drawable.forest_rainy);
            tabLayout.setBackgroundColor(getResources().getColor(R.color.rainy));
            viewPager.setBackgroundColor(getResources().getColor(R.color.rainy));
        } else {
            currentWeatherImage.setBackgroundResource(R.drawable.forest_sunny);
            tabLayout.setBackgroundColor(getResources().getColor(R.color.sunny));
            viewPager.setBackgroundColor(getResources().getColor(R.color.sunny));
